...
class DatabaseTest {
    ...
    void RenameOperation() throws Exception {
        Database database = new Database("/home/oleksandryemets/Documents/test/test.json");
...
//        Result result = database.query("ALTER TABLE %s RENAME COLUMN %s TO %s", testTable, name, new_column_mame");
